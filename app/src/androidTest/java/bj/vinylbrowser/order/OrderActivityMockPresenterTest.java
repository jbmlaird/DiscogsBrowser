...
//    private OrderEpxController epxController;
...
//                epxController.setOrderDetails(order));
...
//                RecyclerViewActions.scrollToPosition(epxController.getAdapter().getItemCount() - 1));
