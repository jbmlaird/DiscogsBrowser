...
import bj.rxjavaexperimentation.detailedview.epoxy.DetailedHeaderModel_;
import bj.rxjavaexperimentation.detailedview.epoxy.MemberModel_;
import bj.rxjavaexperimentation.detailedview.epoxy.ReleasesModel_;
import bj.rxjavaexperimentation.detailedview.epoxy.SubHeaderModel_;
 ...
 */
@Singleton
public class DetailedController extends EpoxyController
{
    ...
    @Inject
    public DetailedController(DetailedContract.View view, Context context, ArtistsBeautifier artistsBeautifier)
    {
        this.view = view;
    ...
    {
        new DetailedHeaderModel_(context)
                .id("header")
                .title(title)
                .subtitle(subtitle)
                .imageUrl(imageUrl)
