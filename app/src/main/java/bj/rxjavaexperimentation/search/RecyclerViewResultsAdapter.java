...
import bj.rxjavaexperimentation.discogs.gson.artist.ArtistResult;
...
public class RecyclerViewResultsAdapter extends RecyclerView.Adapter<RecyclerViewResultsAdapter.MyViewHolder>
{
    ...
    public RecyclerViewResultsAdapter(SearchPresenter searchPresenter, Context context, ArrayList<Object> searchResults)
    {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position)
    {
        ...
        if (searchResults.get(holder.getAdapterPosition()) instanceof ArtistResult)
        {
