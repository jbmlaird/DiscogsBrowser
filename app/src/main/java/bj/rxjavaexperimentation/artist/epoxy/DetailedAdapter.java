...
import bj.rxjavaexperimentation.label.epoxy.DetailedLabelModel_;
...
{
    private HeaderModel_ detailedHeaderModel;
    ...
    @Inject
    public DetailedAdapter(ArtistContract.View view, Context context, ArtistsBeautifier artistsBeautifier)
    {
        enableDiffing();
        this.view = view;
