 ...
 */
public class MarketplaceEpxController extends EpoxyController
{
    ...
    public MarketplaceEpxController(Context context, MarketplaceContract.View view, ImageViewAnimator imageViewAnimator, NumberFormatWrapper numberFormatWrapper)
    {
